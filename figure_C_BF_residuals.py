...
def main():
    ...
    MODEL_DIAG_PATH = "/u/homes/biv20/repos/unsupervised_cells_supn/example_train_bf_diag.yaml"
    MODEL_CHOL_PATH = "/u/homes/biv20/repos/unsupervised_cells_supn/example_train_bf_supn_l100.yaml"
    #MODEL_CHOL_PATH = "/u/homes/biv20/repos/unsupervised_cells_supn/example_train_bf_supn.yaml"
    #MODEL_CHOL_PATH = "/u/homes/biv20/repos/unsupervised_cells_supn/oldsupn_bf.yaml"
    ...
    #        pretrained_mean=False), objective="nll")
    ...
    # No restoration for comparison
    model_chol = load_model(MODEL_CHOL_PATH, map_location="cuda:{}".format(DEVICE), 
            pretrained_mean=False)
    ...
    for axidx in range(TEST_POINTS):
        ...
        sph=axes[axidx,2].imshow(L2_square[axidx,0].cpu(), cmap='viridis', vmin=0, vmax=10)
        #cbar2 = fig.colorbar(sph, ax=axes[2,axidx])
        #cbar2.ax.tick_params(labelsize=6)
        diag=axes[axidx,3].imshow(Diag_square[axidx,0].cpu(), cmap='viridis', vmin=0, vmax=10)
        #cbar3 = fig.colorbar(diag, ax=axes[3,axidx])
        #cbar3.ax.tick_params(labelsize=6)
        supn=axes[axidx,4].imshow(Lr_square[axidx,0].cpu(), cmap='viridis', vmin=0, vmax=10)
